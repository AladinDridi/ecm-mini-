...
$sql = "SELECT id, title, start, end, color FROM events where user_name='$nom_user'";
...
<head>
    ...
    <title>filtrer les membres</title>
...
<body>
    ...
    <form method="POST">
    <label for="stat">selectionnez</label>
    <span class="input-group-addon"><i class="fa fa-user"></i></span>
     <select name="username" class="form-control">
        <?php echo $utilisateurs ; ?>
     </select>
                            
        <Button type="submit" class="btn btn-primary form-control" name="submit">afficher </Button>
