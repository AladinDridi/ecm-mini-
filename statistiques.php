...
$connect=mysqli_connect($host,$user,$pass,$db); 
 $query = "SELECT status, count(*) as number FROM taches  GROUP BY status";  
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                ...
                var options = {  
                      title: 'Taux avancement en génerale',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
...
<body>
 ...
 <div class="btn-group">
  <button  onclick="document.location.href='taches.php'" class="btn"> tâches</button>
    ...
    <h2 style="text-align:center;">Selectionnez un projet</h2>
    <div class="form-group">
    <form method="POST" action="filter_project.php">
