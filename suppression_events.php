		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent.php">
			  ...
			  <div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">ajouter évenement</h4>
			  </div>
			  <div class="modal-body">
                 ...
                 <select name="users_name" class="selectpicker">
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="editEventTitle.php">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">modifier/supprimer</h4>
			  </div>
			  <div class="modal-body">
				  ...
				  <div class="form-group">
				    ...
				    <div class="form-group"> 
						<div class="col-sm-offset-2 col-sm-10">
						  <div class="checkbox">
							<label class="text-danger"><input type="checkbox"  name="delete"> suppression</label>
						  </div>
						</div>
					</div>
