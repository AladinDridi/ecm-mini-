...
var dayIDs = [ 'Dima', 'Lun', 'Mar', 'Mer', 'Jeu', 'Vend', 'Sam' ];
var unitsDesc = [ 'Année', 'Mois', 'Semaine', 'Jours', 'Heure', 'minute', 'seconde', 'milliseconde' ]; // descending
...
function diffDayTime(a, b) {
	return moment.duration({
		days: a.clone().stripTime().diff(b.clone().stripTime(), 'Jours'),
...
function computeDurationGreatestUnit(duration, durationInput) {
	...
	if (unit === 'Semaine' && typeof durationInput === 'object' && durationInput.days) {
		unit = 'Semaine';
	}
...
*/
var largeTokenMap = {
	Y: { value: 1, unit: 'Année' },
	M: { value: 2, unit: 'Mois' },
	W: { value: 3, unit: 'Semaine' }, // ISO week
	w: { value: 3, unit: 'Semaine' }, // local week
	D: { value: 4, unit: 'Jours' }, // day of month
	d: { value: 4, unit: 'Jours' } // day of week
};
