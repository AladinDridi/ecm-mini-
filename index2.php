...
<body>
    ...
    <!-- submenu -->
  <button onclick="document.location.href='suppression_events.php'" class="btn">suppression</button>
    <button  class="btn" onclick="document.location.href='filtrer_calendar.php'">filtrage</button>
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent.php">
			  ...
			  <div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">ajouter evenement</h4>
			  </div>
			  <div class="modal-body">
				  ...
				  <div class="form-group">
                   ...
                   <div class="form-group">
			<label for="username" class="col-sm-2 control-label">users</label>
			<div class="col-sm-10">
			<select name="username" class="form-control" id="color">
             <?php echo $list_users; ?>
...
<script type="text/javascript">
    ...
    monthNames: ['Janvier','Fevrier','MArs','Avril','Mai','Juin','Juillet','Août','Septembre','Octobre','Novembre','dicembre'],
    monthNamesShort: ['Jan','Fev','Mar','Avr','Mai','Juin','Juil','Août','Sep','Oct','Nov','Dic'],
